[![Build status](https://ci.appveyor.com/api/projects/status/rptcodfprvbn704p?svg=true)](https://ci.appveyor.com/project/ripodgor/ajava-qa46-2)
...
Пришлите на проверку ссылку на ваш [репозиторий](https://github.com/ripodgor/Ajava_QA46_2). Удостоверьтесь, что в истории сборки были как success, так и fail, иначе будет не видно, как вы проверяли, что сборка падает в CI.
